...
@section('content')
    ...
    <div class="container-fluid">
        <div class="form-group">
            <div class="col-sm-12">
                <button class="btn btn-success"><a href="/add-country">Add Category</a></button>
            </div>
        </div>
        <!-- ============================================================== -->
        <!-- Start Page Content -->
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $country -> name }}</td>
                                        <td><a href="/edit-country/{{ $country -> id }}">Edit</a></td>
                                        <td><a href="/delete-country/{{ $country -> id }}">Delete</a></td>
                                    </tr>
                                    @endforeach
