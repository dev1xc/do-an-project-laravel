        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <div class="response-area">
                    ...
                    <ul class="media-list" id="{{ $item->id_blog }}">
                        <li class="media" id= {{ $item->id_blog }}>

                            <a class="pull-left" href="#">
                                <img class="media-object" src="images/blog/man-two.jpg" alt="">
                            </a>
                            <div class="media-body" id="{{ $item->id_blog }}">
                                ...
                                <p>{{ $item -> comment }}</p>
                                <a class="btn btn-primary reply_comment"  id={{ $item->id_blog }} ><i class="fa fa-reply"></i>Replay</a>
                        ...
                        @foreach ($data_cmt_son as $son)
                            @if($item->id_blog == $son->blog_father)
