...
class UserBlogController extends Controller
{
    ...
    public function detailblog(Request $request, $id) {
        ...
        $joinInner2 = DB::table('comment')->join('users','comment.id_user','=','users.id')->where('')->get();
        $id_get_user = [];
        ...
        return view('frontend.blog.blog-detail', compact('data','data_cmt','data_cmt_son','getAvg','getData','joinInner'));
    }
