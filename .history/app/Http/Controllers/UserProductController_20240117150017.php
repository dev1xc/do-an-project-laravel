    ...
    public function create_image(Request $request) {
        ...
        if($request->hasFile('image'))
        {
            ...
            foreach($request->file('image') as $image)
            {
                ...
                Product::make($image->getRealPath())->save($path);
                Product::make($image->getRealPath())->resize(50, 70)->save($path2);
                Product::make($image->getRealPath())->resize(200, 300)->save($path3);
