...
//get price range
Route::get('/get-price-range', [UserProductController::class, 'getPriceRange'])->name('price-range');
Route::get('/your-url', [UserProductController::class, 'yourMethod'])->name('your-url');
//get shop
