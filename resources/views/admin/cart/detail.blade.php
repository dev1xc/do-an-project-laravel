            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h1>Total is <span style="color: red">{{ $temp }}</span></h1>
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">id_hang</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart_product">
                                            <a href=""><img src="{{ asset('/upload/product/image/'.$category['image']) }}" alt="" style="height: 100px"/></a>
                                        </td>
                                        <td>{{ $category['quantity'] }}</td>
                                        <td>{{ $category['price'] }}</td>
                                        <td>{{ $category['price'] * $category['quantity'] }}</td>
                                    </tr>
                                    @endforeach
